...
| 変数名 | 説明 |
| - | - |
| `GOOGLE_FIT_CREDENTIALS_JSON` | Google OAuth2 認証情報 JSON (`authorized_user` 形式) |
...
5. `tools/prepareFit` で認証を行い、`GOOGLE_FIT_CREDENTIALS_JSON` の値を取得
6. 取得した JSON を GitHub Secrets に `GOOGLE_FIT_CREDENTIALS_JSON` として登録
